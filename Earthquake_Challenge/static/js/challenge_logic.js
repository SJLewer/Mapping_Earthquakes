...
d3.json(majorEqData).then(function(data) {
  ...
  function mestyleInfo(feature) {
    return {
      opacity: 1,
      fillOpacity: 1,
      fillColor: megetColor(feature.properties.mag),
      color: "#000000",
      radius: megetRadius(feature.properties.mag),
      stroke: true,
      weight: 0.5
    };
  }
  ...
  function megetRadius(magnitude) {
    if (magnitude === 0) {
      return 1;
    }
    return magnitude * 4;
  ...
  L.geoJson(data, {
    ...
    onEachFeature: function (feature,layer) {
      layer.bindPopup("M4.5+ Earthquake<br>Magnitude: " + feature.properties.mag + "<br>Location: " + feature.properties.place);
    }
  }).addTo(majorEQ);
  ...
  //Access the plate GeoJSON URL from GetHub
